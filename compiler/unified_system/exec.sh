...
cd .. &&
cp vprexocompiler/data/$1_exo.c pequin/pepper/src/ &&
cp vprexocompiler/data/$1_ti.c pequin/pepper/apps/ &&
cp vprexocompiler/data/$1_te.c pequin/pepper/apps/ &&
cp vprexocompiler/data/$1_ts.c pequin/pepper/apps/ &&
cd ViperToolsLinux/silicon &&

echo -e "\n\n+---------------------------+" &&
echo -e "| Verifying Te->Ts Proof... |" &&
echo -e "+---------------------------+\n" &&
sbt "run --z3Exe=../z3/bin/z3 ../../vprexocompiler/data/$1_TeTs.vpr" &&

echo -e "\n\n+---------------------------+" &&
echo -e "| Verifying Ti->Te Proof... |" &&
echo -e "+---------------------------+\n" &&
sbt "run --z3Exe=../z3/bin/z3 ../../vprexocompiler/data/$1_TiTe.vpr" &&
